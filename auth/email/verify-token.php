<?php
// /var/www/html/public/rwa/auth/email/verify-token.php
...
<div class="wrap">
  <div class="card">
    ...
    <div class="sub" style="margin-top:8px;">This page confirms your standalone RWA profile email token.</div>

    <div class="msg <?= h($msgType) ?>"><?= h($msg) ?></div>

    <div class="actions">
      <a href="/rwa/profile/index.php" class="btn gold">BACK TO PROFILE</a>
      <a href="/rwa/auth/email/verify-email.php" class="btn">VERIFY EMAIL PAGE</a>
    </div>
  </div>
</div>
